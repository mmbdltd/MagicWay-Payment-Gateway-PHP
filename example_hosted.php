...
<head>
    ...
    <meta name="author" content="MagicWay">
    <title>Example - Checkout | MagicWay</title>
...
<div class="container">
    <div class="py-5 text-center">
        <h2>Checkout - MagicWay</h2>
        <p class="lead">Below is an example form built entirely with Bootstrap’s form controls. We have provided this sample form for understanding Checkout with MagicWay.</p>
    </div>
